...
extension EditItemVC: UITextFieldDelegate , UITextViewDelegate {
    ...
    */
    func registerKeyboardNotifications() {
        NotificationCenter.default.addObserver(self, selector: #selector(EditItemVC.keyboardDidShow),
                                               name: NSNotification.Name.UIKeyboardDidShow, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(EditItemVC.keyboardWillHide),
    ...
    */
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        if textField == itemNameField {
            itemPriceField.becomeFirstResponder()
        }
        else {
    ...
    */
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
        changeImgBtn.isEnabled = false
        activeTextView = itemDescTextView
        scrollView.isScrollEnabled = true
        
        if textView == itemDescTextView { //descField & ActiveField interchangable inside this scope
            if itemDescTextView.textColor == UIColor.lightGray {
                itemDescTextView.text = nil
                itemDescTextView.textColor = UIColor.black
            }
        }
    }
    ...
    func textViewDidEndEditing(_ textView: UITextView) {
        ...
        activeTextView = nil
        scrollView.isScrollEnabled = false
        if itemDescTextView.text.isEmpty {
            itemDescTextView.text = "Insert Description"
            itemDescTextView.textColor = UIColor.lightGray
        }
    }
